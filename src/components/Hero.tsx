...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-white via-red-50/30 to-yellow-50/20">
      ...
      <div className="absolute bottom-20 left-10 w-32 h-32 bg-yellow-300/30 rounded-full blur-2xl" style={{ animationDelay: '1s' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 text-foreground leading-tight">
              Raih Impianmu Bersama Kami! <Sparkles className="inline w-12 h-12 text-yellow-500" />
            </h1>
          ...
          >
            ...
            <div className="relative bg-white p-4 border-3 border-foreground/80 rounded-3xl shadow-scrapbook transform rotate-2 hover:rotate-0 transition-bounce">
              <img
                src={heroImage}
                alt="Gedung Neutron Bandung-2"
                className="w-full aspect-[4/3] object-cover rounded-2xl border-2 border-foreground/60"
              />
